...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20240418_micentroescolar_44f21db6513187297849_20240418081043_archive.daf';
        const ARCHIVE_SIZE       = '64721189';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '44f21db-18081043';
        const SECONDARY_PACKAGE_HASH = 'e101681-18081043';
